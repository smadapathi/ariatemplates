...
Aria.classDefinition({
    ...
    $constructor : function () {
        ...
        this.setTestEnv({
            template : "test.aria.widgets.form.autocomplete.multiautocomplete.test3.MultiAutoDataCheckTpl",
            data : this.data
        });
    ...
    $prototype : {
        ...
        runTemplateTest : function () {
            this.synEvent.click(this.getInputField("MultiAuto3"), {
        ...
        typeSomething : function (evt, callback) {
            ...
            this.synEvent.type(this.getInputField("MultiAuto3"), "air", {
                fn : this._wait,
                scope : this,
        ...
        _selectVal : function () {
            this.synEvent.type(this.getInputField("MultiAuto3"), "[down][down][enter]", {
                fn : this._typeAgain,
                scope : this
            });
        },
        _typeAgain : function () {
            this.synEvent.type(this.getInputField("MultiAuto3"), "a", {
                fn : this._wait,
                scope : this,
