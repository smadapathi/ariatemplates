...
Aria.classDefinition({
    ...
    $constructor : function () {
        ...
        this.setTestEnv({
            template : "test.aria.widgets.form.autocomplete.multiautocomplete.test4.MultiAutoPrefillTpl",
            data : this.data
        });
    ...
    $prototype : {
        ...
        runTemplateTest : function () {
            var parentNode = this.getInputField("MultiAuto4").parentNode, suggestionNode = parentNode.childNodes;
            ...
            for (var j = 0; j < suggestionNode.length - 1; j++) {
                this.assertEquals(suggestionNode.childNodes.length, 2, "The Wrong No. of elements are prefilled.");
                var element = suggestionNode.childNodes[j].innerText || suggestionNode.childNodes[j].textContent;
