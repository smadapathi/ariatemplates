...
Aria.classDefinition({
    ...
    $prototype : {
        ...
        runTemplateTest : function () {
            ...
            this.synEvent.click(this.getInputField("MultiAuto1"), {
        ...
        typeSomething : function (evt, callback) {
            ...
            this.synEvent.type(this.getInputField("MultiAuto1"), "air", {
                fn : this._wait,
                scope : this,
        ...
        _selectVal : function () {
            this.synEvent.type(this.getInputField("MultiAuto1"), "[down][down][enter]", {
                fn : this._typeAgain,
                scope : this
            });
        },
        _typeAgain : function () {
            this.synEvent.type(this.getInputField("MultiAuto1"), "fi", {
                fn : this._wait,
                scope : this,
        ...
        _selectVal2 : function () {
            this.synEvent.type(this.getInputField("MultiAuto1"), "[down][enter]", {
                fn : this._checkSelected,
                scope : this
            });
        },
        _checkSelected : function () {
            var parentNode = this.getInputField("MultiAuto1").parentNode;
            this.assertEquals(this.getInputField("MultiAuto1").value, "", "The Input Field should be empty.");
